...
def load(
    ...
    instantiateConns=True,
    instantiateStims=True,
    instantiateRxD=True,
...
# ------------------------------------------------------------------------------
def createExportNeuroML2(
    netParams=None, simConfig=None, output=False, reference=None, connections=True, stimulations=True, format='xml'
):
    """
